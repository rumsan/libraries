...
export const ERRORS = {
  ...
  AUTH_USERNAME_EXISTS: RSE('This username is already registered with another user.', 'AUTH_USERNAME_EXISTS', 409),
  USERNAME_EXISTS: RSE('Username already exists.', 'USERNAME_EXISTS', 409),
  ACCOUNT_LOCKED: RSE('Account is locked due to multiple failed login attempts. Please try again later.', 'ACCOUNT_LOCKED', 423),
